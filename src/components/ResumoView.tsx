  ...
  return (
    <div className="space-y-6">
      {resumo.subtopicos.map((s) => (
        <div key={s.subtopico} className="rounded-lg border border-white/10 bg-white/[0.02] p-5">
          ...
          <div className="rounded-md bg-black/20 p-4">
            <p className="mb-2 text-xs font-semibold uppercase tracking-wide text-gray-400">Exemplo resolvido</p>
