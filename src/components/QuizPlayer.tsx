    ...
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      {!respondida ? (
        <button
          ...
          className="rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white transition disabled:cursor-not-allowed disabled:opacity-40 hover:bg-blue-500"
        >
          Responder
        </button>
      ) : (
